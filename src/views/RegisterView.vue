<template>
  <section class="bg-gray-50 dark:bg-gray-900">
    <div
      class="flex flex-col items-center justify-center mx-auto md:p-0 lg:py-0"
    >
      <div
        class="w-full bg-white rounded-lg shadow dark:border mt-2 p-4 max-w-sm md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700"
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form  @submit.prevent="handleRegistration" class="space-y-4 md:space-y-6" action="#">
